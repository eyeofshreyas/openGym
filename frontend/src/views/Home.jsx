...
import { bwSheet, goalSheet, dayOverrideSheet, calendarSheet, startFlow, programsSheet, bwDeltaColor } from '../sheets.jsx'
  ...
  return <div className="narrow">
    ...
    {!S.routines.length && !S.active && (
      <div className="card">
        ...
        <div className="muted small" style={{ marginBottom: 12 }}>{t('Set up your weekly routine to get going — or start from a ready-made program.')}</div>
        <Button variant="primary" icon="sparkles" onClick={programsSheet}>{t('Choose a program')}</Button>
